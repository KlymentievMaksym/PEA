...
if n == 1:
    ...
    people_tickets[2] = min(people_tickets[1]+tickets[2][0],
                            people_tickets[0]+tickets[1][1],
                            tickets[0][2])
    ...
    for index in range(3, n):
        # print(
        #     people_tickets[index-1]+tickets[index][0],
        ...
        people_tickets[index] = min(people_tickets[index-1]+tickets[index][0],
                                    people_tickets[index-2]+tickets[index-1][1],
                                    people_tickets[index-3]+tickets[index-2][2])

    print(people_tickets[-1])
